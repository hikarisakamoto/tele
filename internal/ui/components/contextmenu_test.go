...
func TestNewContextMenu_OutgoingItems(t *testing.T) {
	cm := components.NewContextMenu(1, true, 0, 0, false, false, false, defaultKM())
	view := cm.View()
	assert.Contains(t, view, "Reply")
	assert.Contains(t, view, "React")
...
func TestNewContextMenu_IsReply_ShowsJumpToOriginal(t *testing.T) {
	cm := components.NewContextMenu(1, false, 42, 0, false, false, false, defaultKM())
	view := cm.View()
...
func TestNewContextMenu_PhotoMessage_ShowsOpenInViewer(t *testing.T) {
	cm := components.NewContextMenu(1, false, 0, 99, false, false, false, defaultKM())
	view := cm.View()
...
func TestNewContextMenu_VideoMessage_ShowsBothOpenItems(t *testing.T) {
	cm := components.NewContextMenu(1, false, 0, 0, true, false, false, defaultKM())
	view := cm.View()
...
func TestNewContextMenu_VoiceMessage_ShowsPlay(t *testing.T) {
	cm := components.NewContextMenu(1, false, 0, 0, false, true, false, defaultKM())
	view := cm.View()
	assert.Contains(t, view, "Play")
}

func TestContextMenu_OpenInViewer_EmitsOpenInViewerRequest(t *testing.T) {
	cm := components.NewContextMenu(42, false, 0, 99, false, false, false, defaultKM())
...
func TestNewContextMenu_FileShowsDownload(t *testing.T) {
	cm := components.NewContextMenu(1, false, 0, 0, false, false, true, defaultKM())
	assert.Contains(t, strip(cm.View()), "Download")
}

func TestContextMenu_Download_EmitsDownloadFileRequest(t *testing.T) {
	cm := components.NewContextMenu(42, false, 0, 0, false, false, true, defaultKM())
